...
n_ini = int(sys.argv[4])
restore_dir = sys.argv[5]
training.full_train(checkpoint_root, agent, n_iter, save_file, n_ini = n_ini, header = False, restore = True, restore_dir = restore_dir )
t1 = time.time()-t0
